...
<link rel="shortcut icon" href="${ctx }/newrisk/images/title.jpg" type="/x-icon"/>
<title>风险管理信息平台</title>
...
<div class="login_page">
	<div class="login_header">
    	<h1 class="login_logo">
        	<img src="${ctx }/newrisk/images/login_logo.png" width="342" height="32" alt="绘听网络信息平台" />
        </h1>
    </div>
    <div class="login_wap">
    	<div class="login_con">
