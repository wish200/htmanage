...
function Node(id, pid, name, url, title, target,flag,value, icon, iconOpen, open) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
dTree.prototype.add = function(id, pid, name, url, title, target,flag,value, icon, iconOpen, open) {
	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, title, target,flag,value, icon, iconOpen, open);
};
...
dTree.prototype.toString = function() {
	...
	this.completed = true;
	return str;
};dTree.prototype.delNode=function(){	this.aNode=[];};
